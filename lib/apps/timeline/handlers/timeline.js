...
import { timelineSelector, list, more } from '../ducks/timeline';
...
export class Handler extends Component {
  ...
  componentDidMount() {
    const { list, listTeams } = this.props;
...
export default connect(mapStateToProps, { list, listTeams, selectTeam, more, send })(Handler);
